                                    ...
                                    <div class="report-marco ">
                                        ...
                                        <div class="row">
                                                    ...
                                                    @foreach($valFotos[$poll->id]['media'] as $foto)
                                                        <!-- MODAL VENTANA-->
                                                            ...
                                                            <div id="{{$foto->id}}">
                                                                ...
                                                                <a href="{{$valFotos[$poll->id]['urlFoto'].$foto->archivo}}" class="zoom1 btn btn-default" data-fancybox-group="button"><img src="{{$valFotos[$poll->id]['urlFoto'].$foto->archivo}}" width="200px" class="img-thumbnail"></a>
                                                            </div>
                                                        @endforeach
                                                    @endif
                                                </div>
                                            ...
                                            @endif
                                                ...
                                                @if($poll->media ==1)
                                                    <div class="col-md-3 ">
                                                        {{ Form::open(['route' => 'mediaInsertPhotos', 'files' => true, 'method' => 'POST', 'role' => 'form', 'class' => 'form-horizontal', 'id' => 'Photo'.$poll->id, 'validate']) }}
