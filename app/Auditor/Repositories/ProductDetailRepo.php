...
class ProductDetailRepo extends BaseRepo{
    ...
    public function getProductsForCategory($company_id,$category_id)
    {
        $products = ProductDetail::join('products', 'product_detail.product_id','=', 'products.id')->where('product_detail.company_id', $company_id)->where('products.category_product_id',$category_id)->get();
        return $products;
    }
} 