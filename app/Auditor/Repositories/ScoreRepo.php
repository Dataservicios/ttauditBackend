    ...
    public function getDetailWinners($company_id,$audit_id="0",$ubigeo="0",$cadena="0",$ejecutivo="0")
    {
        switch (true) {
            case ($ubigeo == "0") and (($cadena == "HORIZONTAL") or ($cadena == "CADENA")) and ($ejecutivo<>"0"):
                if ($audit_id=="0")
                {
                    $polls = Score::join('stores', 'scores.store_id', '=', 'stores.id')->select('stores.id', 'stores.address','stores.cadenaRuc','stores.type','stores.codclient','stores.fullname','stores.ubigeo','stores.region','stores.district','scores.created_at')->where('scores.company_id', $company_id)->where('stores.test', 0)->where('stores.type', $cadena)->where('stores.ejecutivo', $ejecutivo)->groupBy('scores.store_id')->get();
                }else{
                    $polls = Score::join('stores', 'scores.store_id', '=', 'stores.id')->select('stores.id', 'stores.address', 'stores.cadenaRuc','stores.type','stores.codclient','stores.fullname','stores.ubigeo','stores.region','stores.district','scores.created_at')->where('scores.company_id', $company_id)->where('stores.test', 0)->where('scores.audit_id', $audit_id)->where('stores.type', $cadena)->where('stores.ejecutivo', $ejecutivo)->groupBy('scores.store_id')->get();
                }
                break;
            case ($ubigeo <> "0") and  (($cadena == "HORIZONTAL") or ($cadena == "CADENA")) and ($ejecutivo<>"0"):
                if ($audit_id=="0")
                {
                    $polls = Score::join('stores', 'scores.store_id', '=', 'stores.id')->select('stores.id', 'stores.address', 'stores.cadenaRuc','stores.type','stores.codclient','stores.fullname','stores.ubigeo','stores.region','stores.district','scores.created_at')->where('scores.company_id', $company_id)->where('stores.test', 0)->where('stores.ubigeo', $ubigeo)->where('stores.type', $cadena)->where('stores.ejecutivo', $ejecutivo)->groupBy('scores.store_id')->get();
                }else{
                    $polls = Score::join('stores', 'scores.store_id', '=', 'stores.id')->select('stores.id', 'stores.address', 'stores.cadenaRuc','stores.type','stores.codclient','stores.fullname','stores.ubigeo','stores.region','stores.district','scores.created_at')->where('scores.company_id', $company_id)->where('stores.test', 0)->where('scores.audit_id', $audit_id)->where('stores.type', $cadena)->where('stores.ejecutivo', $ejecutivo)->groupBy('scores.store_id')->get();
                }
                break;
            case ($ubigeo == "0") and  ($cadena =="0") and ($ejecutivo<>"0"):
                if ($audit_id=="0")
                {
                    $polls = Score::join('stores', 'scores.store_id', '=', 'stores.id')->select('stores.id', 'stores.address', 'stores.cadenaRuc','stores.type','stores.codclient','stores.fullname','stores.ubigeo','stores.region','stores.district','scores.created_at')->where('scores.company_id', $company_id)->where('stores.test', 0)->where('stores.ejecutivo', $ejecutivo)->groupBy('scores.store_id')->get();
                }else{
                    $polls = Score::join('stores', 'scores.store_id', '=', 'stores.id')->select('stores.id', 'stores.address', 'stores.cadenaRuc','stores.type','stores.codclient','stores.fullname','stores.ubigeo','stores.region','stores.district','scores.created_at')->where('scores.company_id', $company_id)->where('stores.test', 0)->where('scores.audit_id', $audit_id)->where('stores.ejecutivo', $ejecutivo)->groupBy('scores.store_id')->get();
                }
                break;
            case ($ubigeo == "0") and  ($cadena <>"0") and ($ejecutivo<>"0"):
                if ($audit_id=="0")
                {
                    $polls = Score::join('stores', 'scores.store_id', '=', 'stores.id')->select('stores.id', 'stores.address', 'stores.cadenaRuc','stores.type','stores.codclient','stores.fullname','stores.ubigeo','stores.region','stores.district','scores.created_at')->where('scores.company_id', $company_id)->where('stores.test', 0)->where('stores.cadenaRuc', $cadena)->where('stores.ejecutivo', $ejecutivo)->groupBy('scores.store_id')->get();
                }else{
                    $polls = Score::join('stores', 'scores.store_id', '=', 'stores.id')->select('stores.id', 'stores.address', 'stores.cadenaRuc','stores.type','stores.codclient','stores.fullname','stores.ubigeo','stores.region','stores.district','scores.created_at')->where('scores.company_id', $company_id)->where('stores.test', 0)->where('stores.cadenaRuc', $cadena)->where('scores.audit_id', $audit_id)->where('stores.ejecutivo', $ejecutivo)->groupBy('scores.store_id')->get();
                }
                break;
            case ($ubigeo <> "0") and  ($cadena <> "0") and ($ejecutivo<>"0"):
                if ($audit_id=="0")
                {
                    $polls = Score::join('stores', 'scores.store_id', '=', 'stores.id')->select('stores.id', 'stores.address', 'stores.cadenaRuc','stores.type','stores.codclient','stores.fullname','stores.ubigeo','stores.region','stores.district','scores.created_at')->where('scores.company_id', $company_id)->where('stores.test', 0)->where('stores.ubigeo', $ubigeo)->where('stores.cadenaRuc', $cadena)->where('stores.ejecutivo', $ejecutivo)->groupBy('scores.store_id')->get();
                }else{
                    $polls = Score::join('stores', 'scores.store_id', '=', 'stores.id')->select('stores.id', 'stores.address', 'stores.cadenaRuc','stores.type','stores.codclient','stores.fullname','stores.ubigeo','stores.region','stores.district','scores.created_at')->where('scores.company_id', $company_id)->where('stores.test', 0)->where('scores.audit_id', $audit_id)->where('stores.ubigeo', $ubigeo)->where('stores.cadenaRuc', $cadena)->where('stores.ejecutivo', $ejecutivo)->groupBy('scores.store_id')->get();
                }
                break;
            case ($ubigeo <> "0") and  ($cadena == "0") and ($ejecutivo<>"0"):
                if ($audit_id=="0")
                {
                    $polls = Score::join('stores', 'scores.store_id', '=', 'stores.id')->select('stores.id', 'stores.address', 'stores.cadenaRuc','stores.type','stores.codclient','stores.fullname','stores.ubigeo','stores.region','stores.district','scores.created_at')->where('scores.company_id', $company_id)->where('stores.test', 0)->where('stores.ubigeo', $ubigeo)->where('stores.ejecutivo', $ejecutivo)->groupBy('scores.store_id')->get();
                }else{
                    $polls = Score::join('stores', 'scores.store_id', '=', 'stores.id')->select('stores.id', 'stores.address', 'stores.cadenaRuc','stores.type','stores.codclient','stores.fullname','stores.ubigeo','stores.region','stores.district','scores.created_at')->where('scores.company_id', $company_id)->where('stores.test', 0)->where('scores.audit_id', $audit_id)->where('stores.ubigeo', $ubigeo)->where('stores.ejecutivo', $ejecutivo)->groupBy('scores.store_id')->get();
                }
                break;
            case ($ubigeo == "0") and  (($cadena == "HORIZONTAL") or ($cadena == "CADENA")):
                if ($audit_id=="0")
                {
                    $polls = Score::join('stores', 'scores.store_id', '=', 'stores.id')->select('stores.id', 'stores.address', 'stores.cadenaRuc','stores.type','stores.codclient','stores.fullname','stores.ubigeo','stores.region','stores.district','scores.created_at')->where('scores.company_id', $company_id)->where('stores.test', 0)->where('stores.type', $cadena)->groupBy('scores.store_id')->get();
                }else{
                    $polls = Score::join('stores', 'scores.store_id', '=', 'stores.id')->select('stores.id', 'stores.address', 'stores.cadenaRuc','stores.type','stores.codclient','stores.fullname','stores.ubigeo','stores.region','stores.district','scores.created_at')->where('scores.company_id', $company_id)->where('stores.test', 0)->where('scores.audit_id', $audit_id)->where('stores.type', $cadena)->groupBy('scores.store_id')->get();
                }
                break;
            case ($ubigeo <> "0") and  (($cadena == "HORIZONTAL") or ($cadena == "CADENA")):
                if ($audit_id=="0")
                {
                    $polls = Score::join('stores', 'scores.store_id', '=', 'stores.id')->select('stores.id', 'stores.address', 'stores.cadenaRuc','stores.type','stores.codclient','stores.fullname','stores.ubigeo','stores.region','stores.district','scores.created_at')->where('scores.company_id', $company_id)->where('stores.test', 0)->where('stores.ubigeo', $ubigeo)->where('stores.type', $cadena)->groupBy('scores.store_id')->get();
                }else{
                    $polls = Score::join('stores', 'scores.store_id', '=', 'stores.id')->select('stores.id', 'stores.address', 'stores.cadenaRuc','stores.type','stores.codclient','stores.fullname','stores.ubigeo','stores.region','stores.district','scores.created_at')->where('scores.company_id', $company_id)->where('stores.test', 0)->where('scores.audit_id', $audit_id)->where('stores.type', $cadena)->groupBy('scores.store_id')->get();
                }
                break;
            case ($ubigeo == "0") and  ($cadena =="0"):
                if ($audit_id=="0")
                {
                    $polls = Score::join('stores', 'scores.store_id', '=', 'stores.id')->select('stores.id', 'stores.address', 'stores.cadenaRuc','stores.type','stores.codclient','stores.fullname','stores.ubigeo','stores.region','stores.district','scores.created_at')->where('scores.company_id', $company_id)->where('stores.test', 0)->groupBy('scores.store_id')->get();
                }else{
                    $polls = Score::join('stores', 'scores.store_id', '=', 'stores.id')->select('stores.id', 'stores.address', 'stores.cadenaRuc','stores.type','stores.codclient','stores.fullname','stores.ubigeo','stores.region','stores.district','scores.created_at')->where('scores.company_id', $company_id)->where('stores.test', 0)->where('scores.audit_id', $audit_id)->groupBy('scores.store_id')->get();
                }
                break;
            case ($ubigeo == "0") and  ($cadena <>"0"):
                if ($audit_id=="0")
                {
                    $polls = Score::join('stores', 'scores.store_id', '=', 'stores.id')->select('stores.id', 'stores.address', 'stores.cadenaRuc','stores.type','stores.codclient','stores.fullname','stores.ubigeo','stores.region','stores.district','scores.created_at')->where('scores.company_id', $company_id)->where('stores.test', 0)->where('stores.cadenaRuc', $cadena)->groupBy('scores.store_id')->get();
                }else{
                    $polls = Score::join('stores', 'scores.store_id', '=', 'stores.id')->select('stores.id', 'stores.address', 'stores.cadenaRuc','stores.type','stores.codclient','stores.fullname','stores.ubigeo','stores.region','stores.district','scores.created_at')->where('scores.company_id', $company_id)->where('stores.test', 0)->where('stores.cadenaRuc', $cadena)->where('scores.audit_id', $audit_id)->groupBy('scores.store_id')->get();
                }
                break;
            case ($ubigeo <> "0") and  ($cadena <> "0"):
                if ($audit_id=="0")
                {
                    $polls = Score::join('stores', 'scores.store_id', '=', 'stores.id')->select('stores.id', 'stores.address', 'stores.cadenaRuc','stores.type','stores.codclient','stores.fullname','stores.ubigeo','stores.region','stores.district','scores.created_at')->where('scores.company_id', $company_id)->where('stores.test', 0)->where('stores.ubigeo', $ubigeo)->where('stores.cadenaRuc', $cadena)->groupBy('scores.store_id')->get();
                }else{
                    $polls = Score::join('stores', 'scores.store_id', '=', 'stores.id')->select('stores.id', 'stores.address', 'stores.cadenaRuc','stores.type','stores.codclient','stores.fullname','stores.ubigeo','stores.region','stores.district','scores.created_at')->where('scores.company_id', $company_id)->where('stores.test', 0)->where('scores.audit_id', $audit_id)->where('stores.ubigeo', $ubigeo)->where('stores.cadenaRuc', $cadena)->groupBy('scores.store_id')->get();
                }
                break;
            case ($ubigeo <> "0") and  ($cadena == "0"):
                if ($audit_id=="0")
                {
                    $polls = Score::join('stores', 'scores.store_id', '=', 'stores.id')->select('stores.id', 'stores.address', 'stores.cadenaRuc','stores.type','stores.codclient','stores.fullname','stores.ubigeo','stores.region','stores.district','scores.created_at')->where('scores.company_id', $company_id)->where('stores.test', 0)->where('stores.ubigeo', $ubigeo)->groupBy('scores.store_id')->get();
                }else{
                    $polls = Score::join('stores', 'scores.store_id', '=', 'stores.id')->select('stores.id', 'stores.address', 'stores.cadenaRuc','stores.type','stores.codclient','stores.fullname','stores.ubigeo','stores.region','stores.district','scores.created_at')->where('scores.company_id', $company_id)->where('stores.test', 0)->where('scores.audit_id', $audit_id)->where('stores.ubigeo', $ubigeo)->groupBy('scores.store_id')->get();
                }
                break;
        }
