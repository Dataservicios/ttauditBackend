            ...
            $.post(url , params,  function(data) {
                ...
                .done(function(data) {
                    ...
                    if (data.success!=0){
                        ...
                        $('#filter').show('slow');
                        $("#subtitulo").html(data.muestras);
                        var chartData1 = JSON.parse(data.datosModa);
                        creaGraficoColumnasPorBloques(chartData1,divChartModa,true,true,url_base,'','','','','S/.');
                        $("#subtituloModa").html(data.textoModa);
                    }else{
                        $("#subtitulo").html('No Hay Datos');
                        $("#subtituloModa").html('No Hay Datos');
                    }
