                                            ...
                                            <div class="col-md-12 pb">
                                                <div class="report-marco ">
                                                    ...
                                                    <div class="grafico-circle">
                                                        ...
                                                        <div id="{{'chartdiv'.$product->product_id.$valor['poll_id']}}" style="width: 100%; height: 450px;" ></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12 pb">
                                                <div class="report-marco ">
                                                    ...
                                                    <div class="grafico-circle">
                                                        ...
                                                        <div id="{{'chartdivPrio'.$product->product_id.$valor['poll_id']}}" style="width: 100%; height: 450px;" ></div>
                                                    </div>
                                                </div>
                                            </div>
                                        @endif
