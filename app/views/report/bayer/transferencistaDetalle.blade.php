        ...
        <div class="cuerpo-content">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="row">
                        <!--Filtros con combos-->
                        {{Form::open(['route' => 'detailPopEncontradoFilter', 'method' => 'POST', 'role' => 'form'])}}
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                {{Form::hidden('cliente', '0', ['id'=>'cliente'])}}
    ...
    <script>
        function newCampaigne(valor){
            ...
            if(valor.value != 0){
                ...
                var url= "{{ route('detailPopEncontradoTransf') }}" + "/" + valor.value + "/" + fullname ;
