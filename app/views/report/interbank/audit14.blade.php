                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div data-spy="scroll" data-target="#navbar-example2" data-offset="0" class="scrollspy-example">
                                                        ...
                                                        <div class="checkbox ">
                                                            <label>
                                                                {{Form::checkbox('chk[]',  '72',null, ['class' => 'checkbox1'])}}Estudio 04 2017
                                                            </label>
                                                        </div>
                                                        <div class="checkbox ">
                                                            <label>
                                                                {{Form::checkbox('chk[]',  '76',null, ['class' => 'checkbox1'])}}Estudio 05 2017
                                                            </label>
                                                        </div>
                                                        <div class="checkbox ">
                                                            <label>
                                                                {{Form::checkbox('chk[]',  '84',null, ['class' => 'checkbox1'])}}Estudio 06 2017
                                                            </label>
                                                        </div>
                                                        <div class="checkbox ">
                                                            <label>
                                                                {{Form::checkbox('chk[]',  '90',null, ['class' => 'checkbox1'])}}Estudio 07 2017
                                                            </label>
                                                        </div>
