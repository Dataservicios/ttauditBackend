                    ...
                    <div class="row pt pb">
                        ...
                        <!-- END MODAL VENTANA-->
                            ...
                            <div class="col-sm-8 ">
                                        ...
                                        <table class="table">
                                            <tr>
                                                ...
                                                <td>
                                                    @if(is_object($pollsResult['abierto']['objeto']) and (count($pollsResult['abierto']['objeto'])>0))
                                                        @if($pollsResult['abierto']['objeto'][0]->result==1)
                                                            <a class="btn btn-default" href="#" onclick="changeValueSiNo({{$pollsResult['abierto']['objeto'][0]->id}},0,{{$company_id}},'responseOpen'); return false;" role="button" id="button_{{$pollsResult['abierto']['objeto'][0]->id}}">Change</a>
                                                        @else
                                                            <a class="btn btn-default" href="#" onclick="changeValueSiNo({{$pollsResult['abierto']['objeto'][0]->id}},1,{{$company_id}},'responseOpen'); return false;" role="button" id="button_{{$pollsResult['abierto']['objeto'][0]->id}}">Change</a>
                                                        @endif
                                                    @else
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    @if(is_object($pollsResult['permitio']['objeto']) and (count($pollsResult['permitio']['objeto'])>0))
                                                        @if($pollsResult['permitio']['objeto'][0]->result==1)
                                                            <a class="btn btn-default" href="#" onclick="changeValueSiNo({{$pollsResult['permitio']['objeto'][0]->id}},0,{{$company_id}},'responsePermitio'); return false;" role="button" id="button_{{$pollsResult['permitio']['objeto'][0]->id}}">Change</a>
                                                        @else
                                                            <a class="btn btn-default" href="#" onclick="changeValueSiNo({{$pollsResult['permitio']['objeto'][0]->id}},1,{{$company_id}},'responsePermitio'); return false;" role="button" id="button_{{$pollsResult['permitio']['objeto'][0]->id}}">Change</a>
                                                        @endif
                                                    @else
                                                        <a class="btn btn-default" href="#" role="button">Insert</a>
                                                    @endif</td>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    @if(is_object($pollsResult['existe']['objeto']) and (count($pollsResult['existe']['objeto'])>0))
                                                        @if($pollsResult['existe']['objeto'][0]->result==1)
                                                            <a class="btn btn-default" href="#" onclick="changeValueSiNo({{$pollsResult['existe']['objeto'][0]->id}},0,{{$company_id}},'responseExiste'); return false;" role="button" id="button_{{$pollsResult['existe']['objeto'][0]->id}}">Change</a>
                                                        @else
                                                            <a class="btn btn-default" href="#" onclick="changeValueSiNo({{$pollsResult['existe']['objeto'][0]->id}},1,{{$company_id}},'responseExiste'); return false;" role="button" id="button_{{$pollsResult['existe']['objeto'][0]->id}}">Change</a>
                                                        @endif
                                                    @else
                                                        <a class="btn btn-default" href="#" role="button">Insert</a>
                                                    @endif
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    @if(is_object($pollsResult['visible']['objeto']) and (count($pollsResult['visible']['objeto'])>0))
                                                        @if($pollsResult['visible']['objeto'][0]->result==1)
                                                            <a class="btn btn-default" href="#" onclick="changeValueSiNo({{$pollsResult['visible']['objeto'][0]->id}},0,{{$company_id}},'responseVisible'); return false;" role="button" id="button_{{$pollsResult['visible']['objeto'][0]->id}}">Change</a>
                                                        @else
                                                            <a class="btn btn-default" href="#" onclick="changeValueSiNo({{$pollsResult['visible']['objeto'][0]->id}},1,{{$company_id}},'responseVisible'); return false;" role="button" id="button_{{$pollsResult['visible']['objeto'][0]->id}}">Change</a>
                                                        @endif
                                                    @else
                                                        <a class="btn btn-default" href="#" role="button">Insert</a>
                                                    @endif
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    @if(is_object($pollsResult['trabajada']['objeto']) and (count($pollsResult['trabajada']['objeto'])>0))
                                                        @if($pollsResult['trabajada']['objeto'][0]->result==1)
                                                            <a class="btn btn-default" href="#" onclick="changeValueSiNo({{$pollsResult['trabajada']['objeto'][0]->id}},0,{{$company_id}},'responseW'); return false;" role="button" id="button_{{$pollsResult['trabajada']['objeto'][0]->id}}">Change</a>
                                                        @else
                                                            <a class="btn btn-default" href="#" onclick="changeValueSiNo({{$pollsResult['trabajada']['objeto'][0]->id}},1,{{$company_id}},'responseW'); return false;" role="button" id="button_{{$pollsResult['trabajada']['objeto'][0]->id}}">Change</a>
                                                        @endif
                                                    @else
                                                        <a class="btn btn-default" href="#" role="button">Insert</a>
                                                    @endif
                                            ...
                                            <div id="myModalOptions" class="modal fade" tabindex="-1" role="dialog">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
                                                            @if(count($pollsResult['comoEstaVent']['options'])>0)
                                ...
                                @if(count($urlsFotos)>0)
                                    @foreach($urlsFotos as $photo)
                                        <div class="row pt pb">
                                            <div class="col-sm-12 ">
                                                <div id="{{'Controles'}}"><?php $imageVal=rand();?>
                                                    <a href="#" title="Girar Foto  -90 grados" onclick="girarFoto('{{$photo['archivo']}}',1,'{{'ImpresoSOD'}}','{{$photo['urlFoto']}}','<?php echo $imageVal?>','-90'); return false;" class="btn btn-default" href="#" role="button">
                                                        -90
                                                    </a>
                                                    <a href="#" title="Girar Foto -180 grados" onclick="girarFoto('{{$photo['archivo']}}',1,'{{'ImpresoSOD'}}','{{$photo['urlFoto']}}','<?php echo $imageVal?>','-180'); return false;" class="btn btn-default" href="#" role="button">
                                                        -180
                                                    </a>
                                                    <a href="#" title="Girar Foto  90 grados" onclick="girarFoto('{{$photo['archivo']}}',1,'{{'ImpresoSOD'}}','{{$photo['urlFoto']}}','<?php echo $imageVal?>','90'); return false;" class="btn btn-default" href="#" role="button">
                                                        90
                                                    ...
                                                    <a href="{{$photo['urlFoto']}}?dummy=<?php echo $imageVal?>" download="{{$photo['archivo']}}?dummy=<?php echo $imageVal?>">
                                                ...
                                                <div id="{{'ImpresoSOD'}}">
                                                    <a href="{{$photo['urlFoto']}}?dummy=<?php echo $imageVal?>" class="zoom1 btn btn-default" data-fancybox-group="button"><img src="{{$photo['urlFoto']}}?dummy=<?php echo $imageVal?>" ></a>
                            ...
                            <div class="col-sm-4 ">
                                ...
                                <div class="row">
                                    <div class="col-sm-8">
                                        <div class="form-group">
                                            ...
                                            {{ Form::hidden('publicity_id', $publicity_id, array('id' => 'publicity_id')) }}
                                ...
                                @foreach($productForPublicity as $product)
                                    <div class="row">
                                        <div class="col-sm-4">
                                            {{ Form::label('valor1', $product->product->fullname.' : ') }}
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="form-group">
...
<script>
    ...
    function changeValueSiNo(idPollDetail, Value, company_id,div) {
        var divLoading = div;
        var loading= "<div class='" + divLoading +"'><img src='" + url_base +  "/img/loading1.gif" + "' width='40px' ></div>";
...
//        var store_id= $(this).attr('store_id');
    ...
    $( "#btnSave" ).on( "click", function(event) {
        ...
        var data_store = [];
        @foreach($productForPublicity  as $index =>  $product)
            if (principal==0)
        {
        ...
        $.post(url_base + '/saveSOD',  { publicityDetail_id : publicityDetail_id,  sod : data_store, foto : foto, publicity_id : publicity_id,company_id : company_id },
                function(data){
                    //if (item.latitud != 0 && item.longitud != 0){
                    //console.log(data);
    ...
    <script>
        function girarFoto(namePhoto,Tipo,Div,Url,Val,grado) {
            ...
            var jqxhrGirarFoto = $.post("{{route('girarFotos')}}", { foto : namePhoto,grado:grado,  tipo : Tipo},  function(data) {
                ...
                .always(function() {
                    $('#'+Div).html('<a href="'+Url+valAlea+'" class="zoom1 btn btn-default" data-fancybox-group="button"><img src="'+Url+valAlea+'"></a>');
                    $('#'+Div).show(1000,'swing');
