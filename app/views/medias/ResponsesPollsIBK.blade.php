...
<script>
    ...
    function UpdateRegister(poll_details_id,optionSaves,valOtros)
    {
        ...
        console.log(coment);
        var jqxhr = $.post("{{route('updateRegPollDetailAll')}}", { company_id : company_id, poll_detail_id : poll_details_id , result : response_sino, comment : coment,limit : limit, product_id :  product_id, publicity_id : 0  },  function(data) {
            console.log ("success => " + data);
        })
                .done(function() {
