                                                    ...
                                                    <!-- MODAL VENTANA-->
                                                        ...
                                                        <div id="{{$foto['id']}}">
                                                            <div id="{{'Controles'.$foto['id']}}">
                                                                ...
                                                                <a href="#" title="Girar Foto {{$foto['archivo']}} -90 grados" onclick="girarFoto('{{$foto['archivo']}}',1,'{{'Impreso'.$foto['id']}}','{{$foto['urlFoto']}}','<?php echo $imageVal?>','-90'); return false;" class="btn btn-default" href="#" role="button">
                                                                    -90
                                                                </a>
                                                                <a href="#" title="Girar Foto {{$foto['archivo']}} -180 grados" onclick="girarFoto('{{$foto['archivo']}}',1,'{{'Impreso'.$foto['id']}}','{{$foto['urlFoto']}}','<?php echo $imageVal?>','-180'); return false;" class="btn btn-default" href="#" role="button">
                                                                    -180
                                                                </a>
                                                                <a href="#" title="Girar Foto {{$foto['archivo']}} 90 grados" onclick="girarFoto('{{$foto['archivo']}}',1,'{{'Impreso'.$foto['id']}}','{{$foto['urlFoto']}}','<?php echo $imageVal?>','90'); return false;" class="btn btn-default" href="#" role="button">
                                                                    90
                                                            ...
                                                            <div id="{{'Impreso'.$foto['id']}}">
                                                                <a href="{{$foto['urlFoto']}}?dummy=<?php echo $imageVal?>" class="zoom1 btn btn-default" data-fancybox-group="button"><img src="{{$foto['urlFoto']}}?dummy=<?php echo $imageVal?>" width="200px" class="img-thumbnail"></a>
                                                            </div>
                                                        </div>
                                                @endif
                                            @endforeach
                                                ...
                                                @if(count($valFotos[$publicity->id]['arrayFoto'])>0)
                                                    ...
                                                    <div class="btn-group" role="group" aria-label="...">
                                                        @if(is_object($valFotos[$publicity->id]['pollsResult']['comoEstaVent']['objeto']) and (count($valFotos[$publicity->id]['pollsResult']['comoEstaVent']['objeto'])>0))
                                                            @if(count($valFotos[$publicity->id]['pollsResult']['comoEstaVent']['options'])>0)
    ...
    function girarFoto(namePhoto,Tipo,Div,Url,Val,grado) {
        ...
        var jqxhrGirarFoto = $.post("{{route('girarFotos')}}", { foto : namePhoto,grado:grado,  tipo : Tipo},  function(data) {
            ...
            .always(function() {
                ...
                $('#'+Div).show(1000,'swing');
                location.href = '{{ route('mediaDetailPhoto' , array($campaigne->id,$detailAudit->id,0,"0",$objStore->id,$customer->fullname))}}';
            });
    }
