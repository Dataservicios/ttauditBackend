...
<section>
    ...
    <div class="cuerpo">
                        ...
                        <div class="report-marco ">
                            <div class="contenedor-report">
                                ...
                                <div class="btn-group" role="group" aria-label="...">
                                    ...
                                    <div   class="btn btn-default btn-valor">{{$objRoadDetail->road->fullname."(".$objRoadDetail->road->id.")"}}</div>
                                </div>
                                <div class="btn-group" role="group" aria-label="...">
                                    <div   class="btn btn-default btn-si">Auditor:</div>
                                    <div   class="btn btn-default btn-valor">{{$objRoadDetail->road->user->fullname."(".$objRoadDetail->road->user->id.")"}}</div>
                                </div>
                                <div class="btn-group" role="group" aria-label="...">
                                    <div   class="btn btn-default btn-si">Fecha creado:</div>
                                    <div   class="btn btn-default btn-valor">{{$objRoadDetail->created_at}}</div>
                                </div>
                                <div class="btn-group" role="group" aria-label="...">
                                    <div   class="btn btn-default btn-si">Fecha cerrado:</div>
                                    <div   class="btn btn-default btn-valor">{{$objRoadDetail->updated_at}}</div>
                                </div>
                                <div class="btn-group" role="group" aria-label="...">
                                    <div   class="btn btn-default btn-si">Visita:</div>
                                    <div   class="btn btn-default btn-valor">{{$visit_id}}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    @foreach($valFotos[$poll->id]['ObjArrayClase'] as $objetoArray)
                                                        @if(count($objetoArray['objeto'])>0)
                                                            @foreach($objetoArray['objeto'] as $objeto)
                                                                ...
                                                                <div class="row"><?php $valorLogico=false;?>
                                                                    <div class="col-md-8 ">
                                                                    ...
                                                                    <div class="col-md-4 ">
                                                                        ...
                                                                        {{ Form::hidden('user_id', $objRoadDetail->road->user->id) }}
                                                                        {{ Form::hidden('fecha',$objRoadDetail->updated_at) }}
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            ...
                                                                            <div class="btn btn-default btn-valor" id="">
                                                                                ...
                                                                                @else
                                                                                    <?php $idPollOptions = ''?>
                                                                                @endif
                                                                                <a href="#"  id="{{'opcion'.$poll_detail['poll_detail']->id}}" onclick="modalDelete('modalErase','{{'Eliminando - ('.$poll_detail['poll_detail']->id.')'}}', 'Seguro desea Eliminar estos registros?',2,'{{$poll_detail['poll_detail']->id}}','{{$idPollOptions}}'); return false;">
                                                                    ...
                                                                    @else
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-12 ">
                                                                                    <div class="btn-group" role="group" aria-label="...">
                                                                                        <div class="btn btn-default btn-valor">Limite: </div><div class="btn btn-default btn-valor">{{$poll_detail['poll_detail']->limite."(".$poll_detail['poll_detail']->id.")"}}</div>
                                                                                    </div>
                                                                        ...
                                                                        <div class="modal-dialog">
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    ...
                                                                                    {{Form::hidden('user_id', $objRoadDetail->road->user->id, ['id'=>'user_id'])}}
                                                                                    @if($poll_detail['poll_detail']->product_id<>0)
                                                                                        <div class="mensaje-option"></div>
                                                                                    ...
                                                                                    @if($poll->options ==1)
                                                                                        ...
                                                                                        @if (count($valFotos[$poll->id]['responses']['options'])>0)
                                                                                            @foreach ($valFotos[$poll->id]['responses']['options'] as $cont =>$option)
                                                                                                @if(($option->product_id==$poll_detail['poll_detail']->product_id) or ($option->product_id<>''))
                                                                                                    {{ Form::hidden('valOptionsUpdates'.$poll_detail['poll_detail']->id.'[]', $option->id."|", ['id' => 'valOptionsUpdates'.$poll_detail['poll_detail']->id.'[]']) }}
                                                                                                    <?php
                                                                                                    if (in_array($option->id, $valOptions)){
                                                                                                        $valOptionsSaves .= "|".$option->id;
                                                                                                    }?>
                                ...
                                <div id="myModalInsert{{$poll->id}}" class="modal fade" tabindex="-1" role="dialog">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="mensaje-option"></div>
                                                <p>Fecha auditoria: {{$objRoadDetail->created_at}}</p>
                                                {{Form::hidden('company_id_insert', $company_id, ['id'=>'company_id_insert'])}}
                                                {{Form::hidden('user_id_insert', $objRoadDetail->road->user->id, ['id'=>'user_id_insert'])}}
                                                {{Form::hidden('store_id_insert', $objStore->id, ['id'=>'store_id_insert'])}}
                                                {{Form::hidden('fecha_insert'.$poll->id, $objRoadDetail->created_at, ['id'=>'fecha_insert'.$poll->id])}}
                                                {{Form::hidden('visit_id_insert', $visit_id, ['id'=>'visit_id_insert'])}}
                                                <div class="mensaje-option"></div>
                                                @if(count($valFotos[$poll->id]['products'])>0)
                                                ...
                                                @if($poll->options ==1)
                                                    ...
                                                    @if(count($valFotos[$poll->id]['responses']['options'])>0)
                                                        ...
                                                        @foreach ($valFotos[$poll->id]['responses']['options'] as $option)
                                                            {{ Form::checkbox('option'.'[]', $option->id, '', ['id'=>'option'.'[]']) }}
                                                            {{ Form::label('role', $option->options) }}
                                                            @if($option->options=='Otros')
                                                                {{ Form::text('otros', '', ['id'=>'otros']) }}
                                                                <br>
                                                            @endif
                                                            <br>
                                                        @endforeach
        ...
        {{--modal eliminar--}}
        <div id="modalErase" class="modal fade" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default btn-si" data-dismiss="modal" pollDetail="" PollOptionDetails="">Aceptar</button>
                        <button type="button" class="btn btn-default btn-no" data-dismiss="modal">Cerrar</button>
                    </div>
                </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
        </div>
...
<script>
    ...
    function modalDelete(MyModalName,title, message,icon,PollDetail,PollOptionDetails) {
        ...
        $( ".btn-si" ).attr('pollDetail', PollDetail);
        $( ".btn-si" ).attr('PollOptionDetails', PollOptionDetails);
        $('#' + MyModalName).modal({
            backdrop: 'static',
            keyboard: false
        }).show();
...
<script>
    function InsertRegister(poll_id)
    {
        ...
        var visit_id = $("#visit_id_insert").val();
        ...
        var jqxhrInsertPoll = $.post("{{route('insertRegPollDetailAllVisits')}}", { company_id : company_id, store_id : store_id , product_id :  product_id, publicity_id : publicity_id, options : optionStrings, priorities : priorityStrings, poll_id : poll_id, user_id : user_id, sino : response_sino, fecha: fecha_audit, comentario : comentario,otros : otrosStrings,visit_id : visit_id},  function(data) {
            console.log ("success => " + data);
        })
        .done(function() {
...
<script>
    ...
    function UpdateRegister(poll_details_id,optionSaves,valOtros)
    {
        ...
        var optionStrings ='';
        //var optionSaves = $("#valoptions").val();
        var otrosStrings ='';
        var priorityStrings ='';
        ...
        otrosStrings = $("#otros"+poll_details_id).val();
        ...
        var limit = $("#limit" + poll_details_id ).val();
        ...
        console.log(coment);
        var jqxhr = $.post("{{route('updateRegPollDetailAllVisits')}}", { company_id : company_id, poll_detail_id : poll_details_id , result : response_sino, comment : coment,limit : limit, product_id :  product_id, publicity_id : 0, visit_id :  visit_id  },  function(data) {
            console.log ("success => " + data);
        })
                .done(function() {
                ...
                .always(function() {
                    ...
                    if ((optionStrings != optionSaves) || (otrosStrings != valOtros))
                    {
                        ...
                        var jqxhrDelete = $.post("{{route('deleteAllOptionsVisits')}}", { company_id : company_id, store_id : store_id , product_id :  product_id, publicity_id : 0, poll_id: poll_id, visit_id :  visit_id  },  function(data) {
                            console.log ("success => " + data);
                        })
                                .done(function() {
                                ...
                                .always(function() {
                                    ...
                                    if ((optionStrings != optionSaves) || (otrosStrings != valOtros))
                                    {
                                        var jqxhrInsert = $.post("{{route('insertRegPollOptionDetailAllVisits')}}", { company_id : company_id, store_id : store_id , product_id :  product_id, publicity_id : 0, options : optionStrings, priorities : priorityStrings, poll_detail_id : poll_details_id, user_id : user_id,otros: otrosStrings, visit_id :  visit_id},  function(data) {
                                            console.log ("success => " + data);
                                        })
                                            .done(function() {
                                                $('#progress-bar'+poll_details_id).css('width', '60%').attr('aria-valuenow', "0");
...
<script>
    ...
    <script>
        $("div[id^='modalErase']").hide();
        $( ".btn-si" ).on( "click", function() {
            var PollDetailId = $( this ).attr("polldetail");
            var PollOptionDetailId = $( this ).attr("polloptiondetails");
            //console.log(PollDetailId,PollOptionDetailId)
            borrarReg(PollDetailId,PollOptionDetailId);
        });
    </script>
