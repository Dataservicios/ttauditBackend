    ...
    <table>
        <tr><td valign="top">
                <table>
                    ...
                    <tr>
                        <td>Ver la respuesta mediante el sistema de alertas (Necesitara estar logueado) </td>
                        <td><a href="{{ route('alertDetail', $tipoLocal) }}" target="_blank">Hacer Clic Aquí</a>  </td>
                    </tr>
                </table>
            </td>
        </tr>
