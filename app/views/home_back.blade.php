                ...
                <div class="container">
                    ...
                    <div class="navbar-collapse collapse">
                        ...
                        <ul id="ulnav" class="nav navbar-nav navbar-right">
                            <li class="active"><a href="#top" id="bt-inicio">Inicio</a></li>
                            <li><a href="#screenshots" id="bt-reportes">Reportes</a></li>
                            <li><a href="#description" id="bt-servicios">Servicios</a></li>
                            <li><a href="#price" id="bt-cobertura">Cobertura</a></li>
                            <li><a href="#team" id="bt-clientes">Clientes</a></li>
                            <li><a href="#download" id="bt-contacto">Contacto</a></li>
                            <li><a href="http://ttaudit.com/blog/" onclick="window.open('http://ttaudit.com/blog/', '_blank')">Blog</a></li>
                        </ul>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-7 col-md-7">
                            <div class="content">
                                <h1><strong>TT Audit</strong><br>AUDITORIA DE PUNTOS DE VENTA</h1>
        ...
        <div class="screenshots section-padding dark-bg">
            <div class="container">
                ...
                <div class="owl-carousel owl-theme">
                    <div class="item">
                        <a href="home/images/app/app.jpg" data-rel="prettyPhoto"><img src="home/images/app/app.jpg" alt="item photo"></a>
                    </div> <!-- end item -->
                    <div class="item">
                        <a href="home/images/app/app2.jpg" data-rel="prettyPhoto"><img src="home/images/app/app2.jpg" alt="item photo"></a>
                    </div> <!-- end item -->
                    <div class="item">
                        <a href="home/images/app/app3.jpg" data-rel="prettyPhoto"><img src="home/images/app/app3.jpg" alt="item photo"></a>
                    </div> <!-- end item -->
                    <div class="item">
                        <a href="home/images/app/app4.jpg" data-rel="prettyPhoto"><img src="home/images/app/app4.jpg" alt="item photo"></a>
                    </div> <!-- end item -->
                    <div class="item">
                        <a href="home/images/app/app5.jpg" data-rel="prettyPhoto"><img src="home/images/app/app5.jpg" alt="item photo"></a>
                    </div> <!-- end item -->
                    <div class="item">
                        <a href="home/images/app/app6.jpg" data-rel="prettyPhoto"><img src="home/images/app/app6.jpg" alt="item photo"></a>
                    </div> <!-- end item -->
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="price-list">
                        <div class="col-md-5">
                            <img src="home/images/cobertura.png" alt="" class="img-cobertura" style="padding-top:30px;">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="app-dev">
                        ...
                        <div class="col-sm-6 col-md-3 info">
                            <div class="member">
                                <img src="home/images/real.jpg" alt="">
                            </div> <!-- end .member -->
                        </div> <!-- end .info (1) -->

                        <div class="col-sm-6 col-md-3 info">
                            <div class="member">
                                <img src="home/images/ga-logo.jpg" alt="">
                            </div> <!-- end .member -->
                        </div> <!-- end .info (2) -->
                        ...
                        <div class="col-sm-6 col-md-3 info">
                            <div class="member">
                                <img src="home/images/comunal.jpg" alt="">
                            </div> <!-- end .member -->
                        </div> <!-- end .info (3) -->
                ...
                <div class="row">
                    <div class="app-dev">
                        ...
                        <div class="col-sm-6 col-md-3 info">
                            <div class="member">
                                <img src="home/images/interbank.jpg" alt="">
                            </div> <!-- end .member -->
                        </div> <!-- end .info (2) -->

                        <div class="col-sm-6 col-md-3 info">
                            <div class="member">
                                <img src="home/images/alicorp.jpg" alt="">
                            </div> <!-- end .member -->
                        </div> <!-- end .info (3) -->

                        <div class="col-sm-6 col-md-3 info">
                            <div class="member">
                                <img src="home/images/alicorp-soluciones.jpg" alt="">
                            </div> <!-- end .member -->
                        </div> <!-- end .info (3) -->
                ...
                <div class="row">
                    <div class="app-dev">
                        ...
                        <div class="col-sm-6 col-md-3 info">
                            <div class="member">
                                <img src="home/images/logounilever.jpg" alt="">
                            </div> <!-- end .member -->
                        </div> <!-- end .info (2) -->

                        <div class="col-sm-6 col-md-3 info">
                            <div class="member">
                                <img src="home/images/logo-gloria.jpg" alt="">
                            </div> <!-- end .member -->
                        </div> <!-- end .info (3) -->

                        <div class="col-sm-6 col-md-3 info">
                            <div class="member">
                                <img src="home/images/logo-molitalia.jpg" alt="">
                            </div> <!-- end .member -->
                        </div> <!-- end .info (3) -->
                        ...
                        <div class="col-sm-6 col-md-3 info">
                            <div class="member">
                                <img src="home/images/logo-kasnet.jpg" alt="">
                            </div> <!-- end .member -->
                        </div> <!-- end .info (4) -->
                ...
                <div class="container">
                    <div class="header">
                        ...
                        <h3>Traditional Trade Audit SAC<br>
                            Av. Almirante Grau 629 of. 506, Barranco - Lima, Peru.</h3><br>
                        <h3>rpulido@ttaudit.com</h3>
                        <h2> <i class="fa fa-phone"> </i>  (511) 717 2220 - (51) 956 586737</h2>
                    </div> <!-- end .container > .header -->
