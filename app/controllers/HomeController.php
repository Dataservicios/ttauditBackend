...
class HomeController extends BaseController {
	...
	*/
    ...
    public function __construct(CompanyRepo $companyRepo,UserCompanyRepo $userCompanyRepo)
    {
    ...
    public function getCurrentStudies($customer_id)
    {

        $studies = $this->companyRepo->getStudiesForCustomer($customer_id);
        return View::make('report/studiesCampaigne',compact('studies'));
    }
}
