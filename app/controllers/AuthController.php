    ...
    public function login()
    {
        ...
        if (Auth::attempt($credentials, $data['remember']))
        {
            ...
            if (Auth::user()->type=='company'){
                ...
                $studies = $this->campaigneRepo->getStudiesForCustomer($customer->id);
                //dd($studies->toArray());
                if ($customer->id == 3){
                ...
                if ($customer->id == 5)
                {
                    ...
                    if (count($studies)>1){
                        ...
                        return Redirect::route('selectStudies', array($customer->id));
                    }else{
                        return Redirect::to('reportBayer');
                    }
                ...
                {
                    if (Auth::user()->id==612){
                        return Redirect::route('getPhotosInventory',array(139));
                    }
