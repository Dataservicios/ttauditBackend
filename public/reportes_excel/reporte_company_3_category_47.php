...
$query_detalle_puntos = "call sp_reporte_company_3_category_47";
...
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('S2', utf8_encode('CHOCOLATE ALMENDRA TENTACION 12DSP 1CJA'));
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('V2', utf8_encode('CHOCOLATE GALLETA TENTACION 12DSP 1CJA'));
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('Y2', utf8_encode('CHOCOLATE MANI TENTACION 12DSP 1CJA'));
...
$objPHPExcel->setActiveSheetIndex(1)->getStyle('R2:AA2')->applyFromArray($style);
$objPHPExcel->setActiveSheetIndex(1)->getStyle('A3:AA3')->applyFromArray($style_1);
...
$campos = array(
	...
	array('554_result_product', '0'),
	array('554_result_price', '0'),
	array('554_price', '0'),
	array('555_result_product', '0'),
	array('555_result_price', '0'),
	array('555_price', '0'),
	array('556_result_product', '0'),
	array('556_result_price', '0'),
	array('556_price', '0')
);
...
header('Content-Disposition: attachment;filename="REPORTE_FINAL_COMPANY_3_Category_47.xlsx"');
