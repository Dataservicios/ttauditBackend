...
$objPHPExcel->getActiveSheet()->setTitle('Cerrados Mensual Palmeras');

// Set document properties
$objPHPExcel->getProperties()->setCreator("Maarten Balliauw")
    ->setLastModifiedBy("Maarten Balliauw")
    ->setTitle("CERRADOS PALMERAS")
...
header('Content-Disposition: attachment;filename="REPORTE_CERRADOS_PALMERAS.xlsx"');
