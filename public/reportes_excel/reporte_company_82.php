...
$query_detalle_puntos = "call sp_reporte_company_82";
...
$campos = array(
	...
	array('1388_Respuesta', '0'),
	array('1388_Opciones', '0'),
	array('1388_Foto', '1'),
...
$query_detalle_premiados = "call sp_reporte_company_82_premiados";
...
header('Content-Disposition: attachment;filename="Alicorp_Mayorista_82.xlsx"');
