...
$query_detalle_puntos = "call sp_reporte_company_52";
...
$campos = array(
	...
	array('753_Respuesta', '0'),
	array('753_Opciones', '0'),
	array('753_Foto', '1'),

	array('754_Respuesta', '0'),
	array('754_Opciones', '0'),
	array('754_Comentario', '0'),


	array('747_460_Respuesta', '0'),
	array('748_460_Respuesta', '0'),
	array('747_460_Foto', '1'),

	array('747_461_Respuesta', '0'),
	array('748_461_Respuesta', '0'),
	array('747_461_Foto', '1'),

	array('747_462_Respuesta', '0'),
	array('748_462_Respuesta', '0'),
	array('747_462_Foto', '1'),

	array('747_463_Respuesta', '0'),
	array('748_463_Respuesta', '0'),
	array('747_463_Foto', '1'),

	array('747_464_Respuesta', '0'),
	array('748_464_Respuesta', '0'),
	array('747_464_Foto', '1'),

	// CATEGORIA_PRODUCTS

	array('750_59_Respuesta', '0'),
	array('750_59_Comentario', '0'),
	array('751_59_Respuesta', '0'),
	array('751_59_Comentario', '0'),
	//array('751_59_Foto_galeria', '2'),

	array('750_60_Respuesta', '0'),
	array('750_60_Comentario', '0'),
	array('751_60_Respuesta', '0'),
	array('751_60_Comentario', '0'),
	//array('751_60_Foto_galeria', '2'),

	array('750_61_Respuesta', '0'),
	array('750_61_Comentario', '0'),
	array('751_61_Respuesta', '0'),
	array('751_61_Comentario', '0'),
	//array('751_61_Foto_galeria', '2'),

	array('750_62_Respuesta', '0'),
	array('750_62_Comentario', '0'),
	array('751_62_Respuesta', '0'),
	array('751_62_Comentario', '0'),
	//array('751_62_Foto_galeria', '2'),

	array('752_Respuesta', '0'),
	array('752_Comentario', '0'),
	array('752_Foto', '1'),
...
$query_detalle_puntos = "call sp_reporte_company_52_galery";
$resEmp = mysql_query($query_detalle_puntos, $conexion_db) or die(mysql_error());
$total_comercios = mysql_num_rows($resEmp);
$contador_1 = 3;
/* Llenamos el detalle del reporte */
...
$query_detalle_premiados = "call sp_reporte_company_52_premiados";
...
header('Content-Disposition: attachment;filename="Alicorp_Mayorista_52.xlsx"');
