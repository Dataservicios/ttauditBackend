...
$query_detalle_puntos = "call sp_reporte_company_38_category_54";
...
$campos = array(
    ...
    array('511_414_Respuesta', '0'),
    array('512_414_Respuesta', '0'),
    array('513_414_Respuesta', '0'),
    array('510_414_Respuesta', '0'),
    array('414_sod', '0'),
    array('414_foto', '1'),

    array('511_415_Respuesta', '0'),
    array('512_415_Respuesta', '0'),
    array('513_415_Respuesta', '0'),
    array('510_415_Respuesta', '0'),
    array('415_sod', '0'),
    array('415_foto', '1'),

    array('511_416_Respuesta', '0'),
    array('512_416_Respuesta', '0'),
    array('513_416_Respuesta', '0'),
    array('510_416_Respuesta', '0'),
    array('416_sod', '0'),
    array('416_foto', '1'),

    array('511_417_Respuesta', '0'),
    array('512_417_Respuesta', '0'),
    array('513_417_Respuesta', '0'),
    array('510_417_Respuesta', '0'),
    array('417_sod', '0'),
    array('417_foto', '1'),

    array('511_418_Respuesta', '0'),
    array('512_418_Respuesta', '0'),
    array('513_418_Respuesta', '0'),
    array('510_418_Respuesta', '0'),
    array('418_sod', '0'),
    array('418_foto', '1'),

    array('511_419_Respuesta', '0'),
    array('512_419_Respuesta', '0'),
    array('513_419_Respuesta', '0'),
    array('510_419_Respuesta', '0'),
    array('419_sod', '0'),
    array('419_foto', '1'),
...
header('Content-Disposition: attachment;filename="Alicorp_Estudio_7_38_Category_54.xlsx"');
