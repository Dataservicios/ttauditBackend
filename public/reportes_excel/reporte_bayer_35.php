...
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AS2', 'Prioridades de BEROCCA + SUPRADYN ');
...
$objPHPExcel->setActiveSheetIndex(1)->mergeCells('AS2:BC2');


/* Aplica estilo a las cabeceras */

$objPHPExcel->setActiveSheetIndex(1)->getStyle('O2:BC2')->applyFromArray($style);
$objPHPExcel->setActiveSheetIndex(1)->getStyle('A3:BC3')->applyFromArray($style_1);
