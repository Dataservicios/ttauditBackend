...
$query_detalle_puntos = "call sp_agentes_bcp_1($company_id,5)";
...
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(23  + 2 , 2), ('3. Al llegar al establecimiento el cliente incógnito deberá preguntar directamente por el agente de BCP. Ejemplo: Buenos días/tardes, ¿hay agente de BCP aquí? (id = 1)') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(25  + 2 , 2), ('4. ¿El letrero de BCP Agente era visible desde fuera? (id = 4)') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(34  + 2 , 2), ('5. ¿El BCP Agente es visible estando dentro del establecimiento? (id = 5)') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(41  + 2 , 2), ('6. ¿Existe algún otro Agente / corresponsal bancario? (id = 6)') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(43 + 2 , 2), ('7. El CI deberá preguntar, ¿Puedo pagar una tarjeta de crédito de BCP acá? (id = 7)') );
...
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(98 + 2 , 2), '27. El CI deberá mostrar interés: Voy a abrir un negocio, ¿usted me recomendaría tener un agente BCP? (id = 27)' );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(108 + 2  , 2), ('30. Otras apreciaciones a comentar (id = 28)') );


//////////////////////////Nuevas preguntas
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(109 + 2  , 2), ('40. ¿Tus comisiones te las pagan puntualmente?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(110 + 2  , 2), ('41. ¿Me puedes referir a tu ejecutivo BCP?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(112 + 2  , 2), ('42. ¿Existen ofertas para adelanto de sueldo o prestamos a travez de sus agentes?') );
...
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(31  + 2, 3), ('Otros') );
...
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(46  + 2, 3), ('BCP') );
...
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(80  + 2, 3), ('Le dijo como llegar a alguna Tienda BCP') );
...
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(110 + 2 , 3), ('Respuesta') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(111 + 2 , 3), ('Comentario') );
...
$objPHPExcel->setActiveSheetIndex(1)->mergeCells('CW2:DF2');

$objPHPExcel->setActiveSheetIndex(1)->mergeCells('DI2:DJ2');
...
$objPHPExcel->setActiveSheetIndex(1)->getStyle('B2:DK2')->applyFromArray($style);
...
while ($rowEmp = mysql_fetch_assoc($resEmp)) {
    ...
    $objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(31  + 2, $contador_1), ($rowEmp['4_f'] ));
    $objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(32  + 2, $contador_1), utf8_encode($rowEmp['4_Comentario'] ));

    if (($rowEmp['4_Foto']) == null || ($rowEmp['4_Foto']) == "") {
        $objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(313  + 2, $contador_1), '' );
    } else {
    ...
    $objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(39  + 2, $contador_1), utf8_encode(($rowEmp['5_Comentario'] )));
    ...
    $objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(109  + 2, $contador_1), utf8_encode($rowEmp['38_Respuesta'] ));
    $objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(110  + 2, $contador_1), utf8_encode($rowEmp['39_Respuesta'] ));
    $objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(111  + 2, $contador_1), utf8_encode($rowEmp['39_Comentario'] ));
    $objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(112  + 2, $contador_1), utf8_encode($rowEmp['40_Respuesta'] ));
...
$objPHPExcel->getActiveSheet()->getColumnDimension ('di')->setVisible(false);
$objPHPExcel->getActiveSheet()->getColumnDimension ('dj')->setVisible(false);
$objPHPExcel->getActiveSheet()->getColumnDimension ('dk')->setVisible(false);
...
header('Content-Disposition: attachment;filename="REPORTE_BCP.xlsx"');
