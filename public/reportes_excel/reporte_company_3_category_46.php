...
$query_detalle_puntos = "call sp_reporte_company_3_category_46";
...
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('S2', utf8_encode('N. CARAM. SAYON CHICHA MORADA 1CJA 20BOL'));
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('V2', utf8_encode('N. CARAMELO SAYON PERITAS 1CJA 20BOL'));
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('Y2', utf8_encode('N. CARAMELO SAYON GAJO LIMON 1CJA 16BOL'));
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AB2', utf8_encode('N. CARAMELO SAYON BAMBI 1CJA 20BOL'));
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AE2', utf8_encode('CHUPETE SAYON LIMON/CHICHA 15BOL 1CJA'));
...
$objPHPExcel->setActiveSheetIndex(1)->getStyle('R2:AG2')->applyFromArray($style);
...
$campos = array(
	...
	array('549_result_product', '0'),
	array('549_result_price', '0'),
	array('549_price', '0'),
	array('550_result_product', '0'),
	array('550_result_price', '0'),
	array('550_price', '0'),
	array('551_result_product', '0'),
	array('551_result_price', '0'),
	array('551_price', '0'),
	array('552_result_product', '0'),
	array('552_result_price', '0'),
	array('552_price', '0'),
	array('553_result_product', '0'),
	array('553_result_price', '0'),
	array('553_price', '0')
...
header('Content-Disposition: attachment;filename="REPORTE_FINAL_COMPANY_3_Category_46.xlsx"');
