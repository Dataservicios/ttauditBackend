...
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(126 , 3), utf8_encode('Apronax') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(127 , 3), utf8_encode('Aspiria 100') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(128 , 3), utf8_encode('Redoxon') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(129 , 3), utf8_encode('Supradyn Pro natal') );
...
//Si la respuesta es si, indicar que marcas de Bayer est�n exhibidas
   ...
   $objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(125 , $contador_1), utf8_encode($rowEmp['ejecutivo'] ));
	...
	$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(126 , $contador_1), utf8_encode($rowEmp['209_534_comentario'] ));
	$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(127 , $contador_1), utf8_encode($rowEmp['209_538_comentario'] ));
	$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(128 , $contador_1), utf8_encode($rowEmp['209_539_comentario'] ));
	$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(129 , $contador_1), utf8_encode($rowEmp['209_642_comentario'] ));
