...
$query_detalle_puntos = "call sp_consulta_reporte_company_48";
...
$campos = array(
    ...
    array('632_Respuesta', '0'),
    array('632_Opciones', '0'),
    array('632_comentario_otro', '0'),
    array('632_comentario', '0'),
    array('632_Foto', '1'),

    array('633_Respuesta', '0'),
    array('634_Respuesta', '0'),
    array('635_Respuesta', '0'),

    array('636_comentario', '0'),

    array('637_Opciones', '0'),
    array('637_comentario', '0'),

    array('638_Respuesta', '0'),
    array('638_Foto', '1'),

    array('639_Respuesta', '0'),
    array('640_Respuesta', '0'),
...
$objPHPExcel->getActiveSheet()->setAutoFilter('A3:AD3'); //Auto Filter
...
header('Content-Disposition: attachment;filename="Alicorp_VT_48.xlsx"');
