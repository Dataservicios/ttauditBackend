...
$query_detalle_puntos = "call sp_reporte_company_21_category_45";
...
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('U2', utf8_encode(' NU. ACEITE VEG. PRIMOR PREMIUM 1L 12 BOT'));
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('X2', utf8_encode(' NU. ACEITE VEGETAL PRIMOR 1LT 12BOT'));
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AA2', utf8_encode(' ACEITE COCINERO 1LT 12BOT'));
...
header('Content-Disposition: attachment;filename="REPORTE_FINAL_COMPANY_21_Category_45.xlsx"');
