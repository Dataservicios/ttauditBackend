...
$objPHPExcel->getActiveSheet()->setTitle('Cerrados Mensual Promotoria');

// Set document properties
$objPHPExcel->getProperties()->setCreator("Maarten Balliauw")
    ->setLastModifiedBy("Maarten Balliauw")
    ->setTitle("CERRADOS PROMOTORIA")
...
header('Content-Disposition: attachment;filename="REPORTE_CERRADOS_PROMOTORIA.xlsx"');
