...
$query_detalle_puntos = "call sp_reporte_company_22_category_52";
...
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('U2', utf8_encode('NU. REF.NEGRITA CHICHA 35G.12UND.06DSP'));
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('X2', utf8_encode('NU. REF.NEGRITA NARANJA 35G.12UND.06DSP'));
//$objPHPExcel->setActiveSheetIndex(1)->setCellValue('Y2', utf8_encode('NU. REF.NEGRITA PIÑA 35G.12UND.06DSP'));
//$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AB2', utf8_encode('NU. REF.NEGRITA MARACUYA 35G.12UND.06DSP'));
...
$objPHPExcel->setActiveSheetIndex(1)->getStyle('T2:Z2')->applyFromArray($style);
$objPHPExcel->setActiveSheetIndex(1)->getStyle('A3:Z3')->applyFromArray($style_1);
...
$campos = array(
	...
	array('252_Foto', '1'),
	array('253_Respuesta', '0'),
	array('253_Opciones', '0'),
	array('253_Comentario', '0'),
	array('253_Comentario', '0'),

	array('625_result_product', '0'),
	array('625_result_price', '0'),
	array('625_price', '0'),
	array('626_result_product', '0'),
	array('626_result_price', '0'),
	array('626_price', '0')
);
...
header('Content-Disposition: attachment;filename="REPORTE_FINAL_COMPANY_22_Category_52.xlsx"');
