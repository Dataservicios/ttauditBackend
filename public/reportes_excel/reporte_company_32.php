...
$query_detalle_puntos = "call sp_reporte_company_32";
...
/*
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('T2', utf8_encode('¿Local abierto o cerrado?'));
...
$campos = array(
	...
	array('423_Respuesta', '0'),
	array('423_Opciones', '0'),
	array('423_Foto', '1')
);
...
header('Content-Disposition: attachment;filename="Reporte_IBKBIM.xlsx"');
