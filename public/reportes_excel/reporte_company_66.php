...
$query_detalle_puntos = "call sp_reporte_company_66";
...
$campos = array(
	...
	array('957_Respuesta', '0'),
	array('957_Opciones', '0'),
	array('957_Foto', '1'),
...
$query_detalle_premiados = "call sp_reporte_company_66_premiados";
...
header('Content-Disposition: attachment;filename="Alicorp_Mayorista_66.xlsx"');
