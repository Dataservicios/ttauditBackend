...
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(23  + 2 , 2), utf8_encode('3. Al llegar al establecimiento el cliente inc�gnito deber� preguntar directamente por el agente de Interbank. Ejemplo: Buenos d�as/tardes, �hay agente de Interbank aqu�? (id = 112)') );
...
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(37  + 2 , 2), utf8_encode('6. �Existe alg�n otro Agente / corresponsal bancario? (id = 115)') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(39  + 2 , 2), utf8_encode('7. El CI deber� preguntar, �Puedo pagar una tarjeta de cr�dito de Interbank ac�? (id = 116)') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(41  + 2 , 2), utf8_encode('8. En el caso de que exista m�s de un agente en el comercio, preguntar, �ac� puedo pagar mi tel�fono? (id = 117)') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(42  + 2 , 2), utf8_encode('9. Si responde que si en la P8, preguntar �Y en cu�l agente me conviene pagar mi tel�fono? (id = 135)') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(46  + 2 , 2), utf8_encode('10. Si me env�an dinero del exterior �Lo puedo cobrar ac�? (id = 140)') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(47  + 2 , 2), utf8_encode('11. Escoger tipo de Transacci�n (id = 139)') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(51  + 2 , 2), utf8_encode('12. Al preguntar si se pod�a hacer la operaci�n correspondiente, �el dependiente acept� realizar la operaci�n? (id = 118)') );
...
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(59  + 2 , 2), utf8_encode('16. Despu�s de esperar (id = 122)') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(61  + 2 , 2), utf8_encode('17. �La transacci�n se lleg� a realizar de manera exitosa? (Se considera exitosa cuando se entrega el voucher) (id = 123)') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(62  + 2 , 2), utf8_encode('18. �El agente hizo alg�n cobro fuera del voucher? (id = 141)') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(63  + 2 , 2), utf8_encode('19. �Cu�ntos MINUTOS transcurrieron entre que solicit� la transacci�n y la persona termin� (le entreg� el voucher)? (id = 124)') );
...
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(65  + 2 , 2), utf8_encode('21. �Le entregaron ESPONT��NEAMENTE un comprobante luego de la transacci�n? (Si no le entregaron espont�neamente el voucher deben solicitarlo y adjuntarlo al formulario) (id = 126)') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(67  + 2 , 2), utf8_encode('22. (S�LO SI NO SE REALIZ� LA TRANSACCI�N) �Por qu� no se pudo realizar la transacci�n? (id = 127)') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(74  + 2 , 2), utf8_encode('23. (S�LO SI NO SE REALIZ� LA TRANSACCI�N) �Le dieron alguna soluci�n para poder realizar la transacci�n? (id = 136)') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(78  + 2 , 2), utf8_encode('24. En una escala del 0 al 3 donde 0 significa Debajo del est�ndar, 2 Est�ndar y 3 Superior, �c�mo calificar�as la amabilidad de la persona que te atendi�? (id = 128)') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(86  + 2 , 2), utf8_encode('25. En una escala del 0 al 3 donde 0 significa Debajo del est�ndar, 2 Est�ndar y 3 Superior, �c�mo calificar�as el conocimiento de la persona que lo atendi�? (id = 129)') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(91  + 2 , 2), utf8_encode('26. En una escala del 0 al 3 donde 0 significa Debajo del est�ndar, 2 Est�ndar y 3 Superior, �c�mo calificar�as la disposici�n de la persona que lo atendi�? (id = 130)') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(95  + 2 , 2), utf8_encode('27. El CI deber� mostrar inter�s: Voy a abrir un negocio, �usted me recomendar�a tener un agente Interbank? (id = 131)') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(105 + 2  , 2), utf8_encode('28. �Sabe si tienen alguna p�gina web para conseguir informaci�n (id = 132)') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(106 + 2  , 2), utf8_encode('29. �La persona encargada le proporcion� dicha informaci�n (id = 133)') );
