...
$query_detalle_puntos = "call sp_reporte_company_3_category_52";
...
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('S2', utf8_encode('NU. REF.NEGRITA CHICHA 35G.12UND.06DSP'));
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('V2', utf8_encode('NU. REF.NEGRITA NARANJA 35G.12UND.06DSP'));
...
$objPHPExcel->setActiveSheetIndex(1)->getStyle('R2:AD2')->applyFromArray($style);
...
$campos = array(
	...
	array('626_price', '0'),
	array('627_result_product', '0'),
	array('627_result_price', '0'),
	array('627_price', '0'),
	array('628_result_product', '0'),
	array('628_result_price', '0'),
	array('628_price', '0')
);
...
header('Content-Disposition: attachment;filename="REPORTE_FINAL_COMPANY_3_Category_52.xlsx"');
