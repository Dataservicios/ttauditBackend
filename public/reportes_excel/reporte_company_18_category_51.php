...
$query_detalle_puntos = "call sp_reporte_company_18_category_51";
...
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('U2', utf8_encode('NU.FID.DON VITTORIO SPAG.500GR 20BOL'));
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('X2', utf8_encode('NU.FID.DON VITTORIO CANU.RAY.250GR 20BOL'));
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AA2', utf8_encode('FID.LAVAGGI SPAGHETTI 500GR 20BOL'));
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AD2', utf8_encode('FID.LAVAGGI CODO RAYA.F.PLUS 250GR 20BOL'));
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AG2', utf8_encode('FID.ALIANZA SPAGHETTI 500G 20BOL'));
...
$objPHPExcel->setActiveSheetIndex(1)->getStyle('T2:AI2')->applyFromArray($style);
...
header('Content-Disposition: attachment;filename="REPORTE_FINAL_COMPANY_18_Category_51.xlsx"');
