...
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('M2' ,'Cliente compro bloqueador?');
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('P2' ,'Al cliente se le dejó volante y muestra');
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('R2' ,'Al cliente se le pegó material POP');
...
$objPHPExcel->setActiveSheetIndex(1)->getStyle('M2:S2')->applyFromArray($style);
