...
$query_detalle_puntos = "call sp_alicorp_helena_v2(".$company_id.",0)";
...
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AE2' ,'NEGRITA gelatina Limon'   );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AF2' ,'NEGRITA gelatina Uva'   );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AG2' ,'NEGRITA gelatina Piña'   );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AH2' ,'NEGRITA gelatina naranja'   );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AI2' ,'NEGRITA gelatina Diet FRESA'   );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AJ2' ,'NEGRITA gelatina Diet PIÑA'   );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AK2' ,'NEGRITA gelatina Diet NARANJA'   );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AL2' ,'NEGRITA mazamorra morada'   );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AM2' ,'NEGRITA mazamorra Durazno'   );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AN2' ,'NEGRITA mazamorra Piña'   );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AO2' ,'FRUTISIMOS refrescos Mandarina'   );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AP2' ,'FRUTISIMOS refrescos Chicha'   );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AQ2' ,'FRUTISIMOS refrescos Naranja'   );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AR2' ,'FRUTISIMOS refrescos Piña'   );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AS2' ,'FRUTISIMOS refrescos Maracuya'   );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AT2' ,'FRUTISIMOS refrescos Durazno'   );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AU2' ,'NEGRITA refrescos CHICHA'   );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AV2' ,'NEGRITA refrescos NARANJA'   );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AW2' ,'NEGRITA refrescos PIÑA'   );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AX2' ,'NEGRITA refrescos FRESA'   );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AY2' ,'NEGRITA refrescos MARACUYA'   );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AZ2' ,'NEGRITA refrescos DURAZNO'   );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('BA2' ,'NEGRITA refrescos CEBADA'   );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('BB2' ,'NEGRITA refrescos EMOLIENTE'   );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('BC2' ,'KANU Piña'   );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('BD2' ,'KANU Naranja'   );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('BE2' ,'KANU Chicha morada'   );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('BF2' ,'KANU Mango'   );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('BG2' ,'NEGRITA gelatina Fresa 150 gr'   );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('BH2' ,'Cil 1lt'   );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('BI2' ,'Cil 500 ml'   );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('BJ2' ,'Friol 1 lt'   );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('BK2' ,'Friol 500ml'   );
...
$objPHPExcel->setActiveSheetIndex(1)->getStyle('S2:BG2')->applyFromArray($style);
$objPHPExcel->setActiveSheetIndex(1)->getStyle('A3:BG3')->applyFromArray($style_1);
...
$campos = array(
    ...
    array('3_21_Respuesta', '0'),
    array('3_22_Respuesta', '0'),
    array('3_23_Respuesta', '0'),
    array('3_24_Respuesta', '0'),
    array('3_25_Respuesta', '0'),
    array('3_26_Respuesta', '0'),
    array('3_27_Respuesta', '0'),
    array('3_28_Respuesta', '0'),
    array('3_29_Respuesta', '0'),
    array('3_30_Respuesta', '0'),
    array('3_31_Respuesta', '0'),
    array('3_32_Respuesta', '0'),
    array('3_33_Respuesta', '0'),
    array('3_34_Respuesta', '0'),
    array('3_35_Respuesta', '0'),
    array('3_36_Respuesta', '0'),
    array('3_37_Respuesta', '0'),
    array('3_38_Respuesta', '0'),
    array('3_39_Respuesta', '0'),
    array('3_40_Respuesta', '0'),
    array('3_41_Respuesta', '0'),
    array('3_42_Respuesta', '0'),
    array('3_43_Respuesta', '0'),
    array('3_44_Respuesta', '0'),
    array('3_45_Respuesta', '0'),
);
...
$query_detalle_premiados = "call sp_alicorp_helena_products_v4(".$company_id.",0)";
...
$objPHPExcel->getActiveSheet()->setAutoFilter('A3:BF3'); //Auto Filter
...
$query_detalle_premiados = "call sp_alicorp_helena_premiados_v2(".$company_id.",0)";
$resEmp = mysql_query($query_detalle_premiados, $conexion_db) or die(mysql_error());
$total_comercios = mysql_num_rows($resEmp);
$contador_1 = 3;
