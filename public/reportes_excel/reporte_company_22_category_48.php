...
$query_detalle_puntos = "call sp_reporte_company_22_category_48";
...
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('U2', utf8_encode('DET.BOLIVAR TEC.ANTIPER.FL.360G 30BOL'));
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('X2', utf8_encode('DET.BOLIVAR TEC.ANTIPER.FL.520G 30BOL'));
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AA2', utf8_encode('DET.MARSELLA PETALOS RELAJANT 350G 30BOL'));
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AD2', utf8_encode('DET.MARSELLA PETALOS RELAJANT 500G 30BOL'));
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AG2', utf8_encode('DET. OPAL ULTRA FLORAL 360GR 30BOL'));
...
$objPHPExcel->setActiveSheetIndex(1)->getStyle('T2:BI2')->applyFromArray($style);
$objPHPExcel->setActiveSheetIndex(1)->getStyle('A3:BI3')->applyFromArray($style_1);
...
header('Content-Disposition: attachment;filename="REPORTE_FINAL_COMPANY_22_Category_48.xlsx"');
