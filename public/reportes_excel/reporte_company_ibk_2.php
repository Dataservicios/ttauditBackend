...
$query_detalle_puntos = "call sp_ibk_2($company_id)";
...
//////////////////////////Nuevas preguntas
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(122 + 2  , 2), ('40. ¿Tus comisiones te las pagan puntualmente?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(123 + 2  , 2), ('41. ¿Me puedes referir a tu ejecutivo IBK?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(125 + 2  , 2), ('42. ¿Existen ofertas para adelanto de sueldo o prestamos a travez de sus agentes?') );
...
//// ------------------------Nuevas preguntas----------------------------
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(122 + 2 , 3), ('Respuesta') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(123 + 2 , 3), ('Respuesta') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(124 + 2 , 3), ('Comentario') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(125 + 2 , 3), ('Respuesta') );

$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(126 + 2 , 3), ('Tipo') );

$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(127 + 2 , 3), ('Otros -  El letrero de IBK Agente era visible desde fuera') );  //Temporal --- El letrero de IBK Agente era visible desde fuera
...
$objPHPExcel->setActiveSheetIndex(1)->mergeCells('DV2:DW2');




/* Aplica estilo a las cabeceras */
$objPHPExcel->setActiveSheetIndex(1)->getStyle('B2:DX2')->applyFromArray($style);
$objPHPExcel->setActiveSheetIndex(1)->getStyle('A3:DX3')->applyFromArray($style_1);
...
while ($rowEmp = mysql_fetch_assoc($resEmp)) {
    ...
    $objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(122  + 2, $contador_1), utf8_encode($rowEmp['38_Respuesta'] ));
    $objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(123  + 2, $contador_1), utf8_encode($rowEmp['39_Respuesta'] ));
    $objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(124  + 2, $contador_1), utf8_encode($rowEmp['39_Comentario'] ));
    $objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(125  + 2, $contador_1), utf8_encode($rowEmp['40_Respuesta'] ));

    $objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(126  + 2, $contador_1), utf8_encode($rowEmp['comment'] ));

//    $objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(127  + 2, $contador_1), utf8_encode($rowEmp['comment'] ));
    $objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(127  + 2, $contador_1), ($rowEmp['4_g'] )); // Banner
