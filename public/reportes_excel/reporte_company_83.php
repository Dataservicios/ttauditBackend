...
$query_detalle_puntos = "call sp_consulta_reporte_company_83";
...
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('R2','¿ Permitió realizar capacitación ?');
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('U2','¿Se realizó la capacitación satisfactoriamente ?');
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('X2','¿ Permitió colocar sticker ?');
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('Z2','¿ Conoce Liga Inter Agente ?');
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AB2','¿ Firmó constancia de capacitación ?');
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AE2','¿ Algún comentario adicional ?');
...
$objPHPExcel->setActiveSheetIndex(1)->getStyle('A3:AG3')->applyFromArray($style_1);
...
$campos = array(
	...
	array('1397_Respuesta', '0'),
	array('1397_Opciones', '0'),
    array('1397_Comentario', '0'),
	array('1397_Foto', '1'),

	array('1398_Respuesta', '0'),
	array('1398_Opciones', '0'),
	array('1398_Comentario', '0'),


    array('1399_Respuesta', '0'),
    array('1399_Comentario', '0'),
    array('1399_Foto', '1'),

    array('1400_Respuesta', '0'),
    array('1400_Foto', '1'),

    array('1401_Respuesta', '0'),
    array('1401_Comentario', '0'),

    array('1402_Respuesta', '0'),
    array('1402_Comentario', '0'),
    array('1402_Foto', '1'),


    array('1404_Respuesta', '0'),
    array('1404_Comentario', '0'),
...
header('Content-Disposition: attachment;filename="IBK_capacitaciones_83.xlsx"');
