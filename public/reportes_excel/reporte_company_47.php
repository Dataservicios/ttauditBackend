...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Q2' ,'Cuenta con Stock de Bloqueador Palmera');
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('R2' ,'Cuando Compro (Días)');
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('S2' ,'Cuanto Stock tiene (Sachets))');


$objPHPExcel->setActiveSheetIndex(0)->setCellValue('T2' ,'Al cliente se le dejó volante');
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('V2' ,'Al cliente se le pegó material POP');
...
$objPHPExcel->setActiveSheetIndex(0)->getStyle('N2:W2')->applyFromArray($style);
$objPHPExcel->setActiveSheetIndex(0)->getStyle('A3:W3')->applyFromArray($style_1);
...
$campos = array(
	...
	array('797_Respuesta', '0'),
	array('798_Comentario', '0'),
	array('799_Comentario', '0'),
...
$objPHPExcel->setActiveSheetIndex(0)->setAutoFilter('A3:W3'); //Auto Filter
