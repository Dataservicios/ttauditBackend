...
$query_detalle_puntos = "call sp_reporte_company_21_category_46";
...
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('U2', utf8_encode('N. CARAMELO SAYON GAJO LIMON 1CJA 16BOL'));
...
$objPHPExcel->setActiveSheetIndex(1)->getStyle('T2:W2')->applyFromArray($style);
$objPHPExcel->setActiveSheetIndex(1)->getStyle('A3:W3')->applyFromArray($style_1);
...
header('Content-Disposition: attachment;filename="REPORTE_FINAL_COMPANY_21_Category_46.xlsx"');
