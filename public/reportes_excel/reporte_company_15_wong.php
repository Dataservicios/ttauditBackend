...
$query_detalle_puntos = "call sp_reporte_company_15_wong";
...
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('CY2', utf8_encode('Victoria - 3 x 2 en Glacitas y tentacion - 3 x 2'));
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('DB2', utf8_encode('Bolivar - Descuento en Bolivar 2.6kg - 33% de descuento'));
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('DE2', utf8_encode('Bolivar Liquido - Descuento en Bolivar Liquido 1.9lt - 33% de descuento'));


$objPHPExcel->setActiveSheetIndex(1)->setCellValue('DH2', utf8_encode('Ventana Detergentes'));
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('DJ2', utf8_encode('Ventana Aceites'));
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('DL2', utf8_encode('Ventana Galletas'));
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('DN2', utf8_encode('Ventana Pastas'));
...
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('DH1', utf8_encode('SOD Ventanas'));
...
$objPHPExcel->setActiveSheetIndex(1)->mergeCells('CY1:DG1');
$objPHPExcel->setActiveSheetIndex(1)->mergeCells('DH1:DO1');
...
$objPHPExcel->setActiveSheetIndex(1)->mergeCells('DH2:DI2');
$objPHPExcel->setActiveSheetIndex(1)->mergeCells('DJ2:DK2');
$objPHPExcel->setActiveSheetIndex(1)->mergeCells('DL2:DM2');
$objPHPExcel->setActiveSheetIndex(1)->mergeCells('DN2:DO2');
...
$objPHPExcel->setActiveSheetIndex(1)->getStyle('M1:DO1')->applyFromArray($style_1);
$objPHPExcel->setActiveSheetIndex(1)->getStyle('M2:DO2')->applyFromArray($style);
...
$campos = array(
	...
	array('promociones_publicity_334_result', '0'),
	array('promociones_publicity_334_comunicacion', '0'),
	array('promociones_publicity_334_foto', '1'),

	array('promociones_publicity_335_result', '0'),
	array('promociones_publicity_335_comunicacion', '0'),
	array('promociones_publicity_335_foto', '1'),

	array('promociones_publicity_336_result', '0'),
	array('promociones_publicity_336_comunicacion', '0'),
	array('promociones_publicity_336_foto', '1'),
...
header('Content-Disposition: attachment;filename="REPORTE_FINAL_COMPANY_15_Wong.xlsx"');
