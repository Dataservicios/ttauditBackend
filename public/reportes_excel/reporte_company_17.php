...
$query_detalle_puntos = "call sp_consulta_reporte_company_17";
...
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(120 , 3), utf8_encode('Ejecutivo') );
...
//Si la respuesta es No, indicar cual de los 4 motivos
	...
	$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(120 , $contador_1), utf8_encode($rowEmp['ejecutivo'] ));
