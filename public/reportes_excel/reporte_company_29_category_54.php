...
$query_detalle_puntos = "call sp_reporte_company_29_category_54";
...
$campos = array(
    ...
    array('fecha', '0'),
    array('hora', '0'),
    array('385_Respuesta', '0'),
    array('385_Opciones', '0'),
    array('385_Foto', '1'),

    array('387_Respuesta', '0'),
    array('387_Opciones', '0'),
    array('387_Comentario', '0'),
    array('386_Comentario', '0'),


    array('389_390_Respuesta', '0'),
    array('390_390_Respuesta', '0'),
    array('391_390_Respuesta', '0'),
    array('388_390_Respuesta', '0'),
    array('390_sod', '0'),
    array('390_foto', '1'),

    array('389_391_Respuesta', '0'),
    array('390_391_Respuesta', '0'),
    array('391_391_Respuesta', '0'),
    array('388_391_Respuesta', '0'),
    array('391_sod', '0'),
    array('391_foto', '1'),

    array('389_392_Respuesta', '0'),
    array('390_392_Respuesta', '0'),
    array('391_392_Respuesta', '0'),
    array('388_392_Respuesta', '0'),
    array('392_sod', '0'),
    array('392_foto', '1'),

    array('389_393_Respuesta', '0'),
    array('390_393_Respuesta', '0'),
    array('391_393_Respuesta', '0'),
    array('388_393_Respuesta', '0'),
    array('393_sod', '0'),
    array('393_foto', '1'),

    array('389_394_Respuesta', '0'),
    array('390_394_Respuesta', '0'),
    array('391_394_Respuesta', '0'),
    array('388_394_Respuesta', '0'),
    array('394_sod', '0'),
    array('394_foto', '1'),

    array('389_395_Respuesta', '0'),
    array('390_395_Respuesta', '0'),
    array('391_395_Respuesta', '0'),
    array('388_395_Respuesta', '0'),
    array('395_sod', '0'),
    array('395_foto', '1')
);
...
header('Content-Disposition: attachment;filename="Alicorp_Estudio_5_29_Category_54.xlsx"');
