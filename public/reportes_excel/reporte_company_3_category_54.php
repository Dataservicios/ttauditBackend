...
$query_detalle_puntos = "call sp_reporte_company_3_category_54";
...
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('S2', utf8_encode('Ventana Salsas'));
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('V2', utf8_encode('Ventana Pastas'));
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('Y2', utf8_encode('Ventana Aceites'));
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AB2', utf8_encode('Ventana Galletas'));
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AE2', utf8_encode('Ventana Refrescos'));
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AH2', utf8_encode('Ventana Detergentes'));
...
$objPHPExcel->setActiveSheetIndex(1)->getStyle('R2:AJ2')->applyFromArray($style);
$objPHPExcel->setActiveSheetIndex(1)->getStyle('A3:AJ3')->applyFromArray($style_1);
...
$campos = array(
    ...
    array('193_22_Respuesta', '0'),
    array('22_sod', '0'),
    array('22_foto', '1'),
    array('193_23_Respuesta', '0'),
    array('23_sod', '0'),
    array('23_foto', '1'),
    array('193_24_Respuesta', '0'),
    array('24_sod', '0'),
    array('24_foto', '1'),
    array('193_25_Respuesta', '0'),
    array('25_sod', '0'),
    array('25_foto', '1'),
    array('193_26_Respuesta', '0'),
    array('26_sod', '0'),
    array('26_foto', '1'),
    array('193_22_Respuesta', '0'),
    array('27_sod', '0'),
...
header('Content-Disposition: attachment;filename="REPORTE_FINAL_COMPANY_3_Category_54.xlsx"');
