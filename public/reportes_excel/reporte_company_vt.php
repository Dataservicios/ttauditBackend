...
$query_detalle_puntos = "call sp_alicorp_vt(".$company_id.")";
...
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AC2','Vendió Promoción?');
...
$objPHPExcel->setActiveSheetIndex(1)->mergeCells('AC2:AG2');
...
$objPHPExcel->setActiveSheetIndex(1)->getStyle('AA2:AG2')->applyFromArray($style);
$objPHPExcel->setActiveSheetIndex(1)->getStyle('A3:AH3')->applyFromArray($style_1);
...
$campos = array(
    ...
    array('5_comentario', '0'),

    array('6_Opciones', '0'),
    array('6_comentario', '0'),
    ...
    array('8_Respuesta', '0'),
    array('8_a', '0'),
    array('8_a_comentario', '0'),
    array('8_b', '0'),
    array('8_b_comentario', '0'),
...
$objPHPExcel->getActiveSheet()->setAutoFilter('A3:AH3'); //Auto Filter
...
header('Content-Disposition: attachment;filename="Alicorp_VT.xlsx"');
