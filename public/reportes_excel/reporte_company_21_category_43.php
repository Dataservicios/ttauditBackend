...
$query_detalle_puntos = "call sp_reporte_company_21_category_43";
...
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('U2', utf8_encode('SALSA TOMATE ALACENA 160GR 24UND'));
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('X2', utf8_encode('SALSA ROJA DON VITTORIO 400GR.12UND'));
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AA2', utf8_encode('CREMA DE AJI TARI 85GR. 24UND'));
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AD2', utf8_encode('N.MAYONESA ALACENA 100CC 24BOL'));
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('AG2', utf8_encode('UCHUCUTA ALACENA 85GR. 24DPK'));
...
$objPHPExcel->setActiveSheetIndex(1)->getStyle('A3:AI3')->applyFromArray($style_1);
...
header('Content-Disposition: attachment;filename="REPORTE_FINAL_COMPANY_21_Category_43.xlsx"');
