...
function creaGraficoColumnasComparacion(data,div, rotation,tamano ) {
...
function creaGraficoColumnasComparacionTransaccion(data,div, rotation,tamano ) {
...
function creaGraficoColumnasComparacionTrato(data,div, rotation,tamano ) {
...
function creaGraficoColumnasComparacionSiNo(data,div, rotation,tamano ) {
