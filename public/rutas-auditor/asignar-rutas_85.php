...
<script>
    ...
    var _markersCompany=[];
    var _infoBox;
    var countIBK=0,countRiqra=0,countBayer= 0,countBayerV= 0,countBayerM= 0,countAlicorp= 0,countAlicorpHulk= 0,countAlicorpAASS=0, countAlicorpClientes=0,countAlicorpMerca=0,countKasnet=0 , countFullCarga=0, countBCP=0 ,countBIM=0;
   ...
   // var marker;
    $(document).ready(function($) {
        ...
        function setupMapa(div){
           ...
           $.post(dominio + '/admin_api/api_company_85.php',{ departament : "<?php echo $_GET['departament'] ?>" }, function(json){
...
//                );
        ...
        function populateMap(data){
            ...
            if(countBayerM > 0) $('#puntosEmpresa').append('<p><input class="customer_id" type="checkbox"  checked="checked"  value="5" ><img src="img/marker_bayer_mercaderismo.png"  > ' + countBayerM +' PDVS</p>')
