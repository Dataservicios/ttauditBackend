...
<script>
    ...
    var _markersCompany=[];
    var _infoBox;
    var countIBK=0,countRiqra=0,countBayer= 0,countBayerV= 0,countBayerM= 0,countBayerMC= 0,countBayerMAASS= 0,countAlicorpVT =0,countAlicorp= 0,countAlicorpHulk= 0,countAlicorpAASS=0, countAlicorpClientes=0,countAlicorpMerca=0,countKasnet=0 , countFullCarga=0, countBCP=0 ,countBIM=0, countPalmeraAuditor=0;
        ...
        function populateMap(data){
            ...
            $.each(data, function(i, item){
                ...
                var icono;
                 ...
                 if(item.customer_id ==1) {
                     ...
                     }else if (item.company_id==113) {
                         countBCP ++;
                         icono='img/maker_bcp.png'

                     } else {
                         if (item.company_id==83){
                             icono='img/maker_full_carga.png'
                         }else{
                             icono='img/maker_interbank.png';
                         }
                         if (item.dif_campaigne ==  'ibk114_28'){
                             icono='img/maker_full_carga.png'
                         }
                         countIBK ++;
                     }
                    ...
                    //icono = google.maps.SymbolPath.CIRCLE;
                     ...
                     if(item.company_id==77){
                         ...
                         if(item.cabecera==1){
                             ...
                             if(item.tipo=='AASS'){
                                 ...
                                 //icono='img/maker_bayer_aass.png';
                                 countBayerMAASS ++;
                             }else{
                                 icono='img/maker_bayer_1.png';
                                 countBayerM ++;
                             }
                         }
                     ...
                     } else if(item.company_id==124 ){
                         countAlicorpClientes ++;
                         if ((item.dif_campaigne==1) ||(item.dif_campaigne==2) || (item.dif_campaigne==3) || (item.dif_campaigne==4) || (item.dif_campaigne==5) || (item.dif_campaigne==6) || (item.dif_campaigne==7)){
                             icono='img/alicorp_vt_' +item.dif_campaigne+'.png'
                         }else{
                     ...
                     else if(item.company_id==85){
                         countAlicorpMerca ++;
                         if(item.tipo=='Mayoristas'){
                             icono='img/marker_bayer_mercaderismo.png'
                         }else{
                             icono='img/maker_alicorp_merc.png'
                         }
                 ...
                 } else if (item.customer_id == 8 ) {
                     if(item.company_id==131){
                         countPalmeraAuditor ++;
                         icono='img/maker_palmera_sum_auditor.png'
                     }
            ...
            var marker = new google.maps.Marker({
               ...
               // _markersCompany[i] = [marker,item.customer_id];
                _markersCompany[i] = [marker,item.company_id];
            ...
            if(countAlicorpClientes > 0) $('#puntosEmpresa').append('<p><input class="customer_id" type="checkbox"  checked="checked"  value="124"><img src="img/maker_alicorp_cliente.png"  > ' + countAlicorpClientes +' PDVS</p>')
            if(countAlicorpMerca > 0) $('#puntosEmpresa').append('<p><input class="customer_id" type="checkbox"  checked="checked"  value="4"><img src="img/maker_alicorp_merc.png"  > ' + countAlicorpMerca +' PDVS</p>')
            if(countBayer > 0) $('#puntosEmpresa').append('<p><input class="customer_id" type="checkbox"  checked="checked"  value="118" ><img src="img/maker_bayer.png"  > ' + countBayer +' PDVS</p>')
            ...
            if(countBayerM > 0) $('#puntosEmpresa').append('<p><input class="customer_id" type="checkbox"  checked="checked"  value="117" ><img src="img/maker_bayer_1.png"  > ' + countBayerM +' PDVS</p>')
            if(countBayerMC > 0) $('#puntosEmpresa').append('<p><input class="customer_id" type="checkbox"  checked="checked"  value="117" ><img src="img/marker_bayer_mercaderismo_cabecera.png"  > ' + countBayerMC +' PDVS</p>')
            if(countBayerMAASS > 0) $('#puntosEmpresa').append('<p><input class="customer_id" type="checkbox"  checked="checked"  value="117" ><img src="img/marker_bayer_mercaderismo_aass.png"  > ' + countBayerMAASS +' PDVS</p>')
            ...
            if(countPalmeraAuditor > 0) $('#puntosEmpresa').append('<p><input class="customer_id" type="checkbox"  checked="checked"  value="131" ><img src="img/maker_palmera_sum_auditor.png"  > ' + countPalmeraAuditor +' PDVS</p>')
    ...
    $('#guarda_ruta').click(function(e) {
        ...
        if(data_store.length < 1  ) {
           ...
           // console.log(date);
            ...
            var response = $.post(dominio + '/saveRoute',  { nombreRuta : nombre, user_id : <?php echo $_GET['user_id'] ?> , id_store : data_store , date: date_ },
                function(data){
                //if (item.latitud != 0 && item.longitud != 0){
                    //console.log(data);
                    if(data.success==1 ){
