...
WHERE
  `medias`.`created_at` BETWEEN :date_ini AND :date_end AND
...
//                         echo $file;
                        ...
                        if (file_exists($file)) {
                            ...
                            $string .= "<td>" .  $row["fullname"] . "</td>" ;
                            $string .= '<td><a href=' . $row["archivo"] . ' target=_blank>'  . $row["archivo"] . '</a></td>';
                            $string .= "<td>"  . filesize_formatted($file) . "</td>";
//                            $string .= '<td>';
//                            $string .= '</td>';
                            $string .= "</tr>";
